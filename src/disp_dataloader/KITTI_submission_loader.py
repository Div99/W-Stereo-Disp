...
def dataloader(filepath, split):
    ...
    depth_test = [filepath + depth_fold + img + '.txt' for img in image]

    return left_test, right_test, calib_test, depth_test
